...
(function(){
  Express = { 
    ...
    redirect : function(url) {
      // TODO: respond / redirect should halt
      this.header('Location', url)
      this.respond('Moved Temporarily')
    },
...
use('response', Express.Logger)
use('response', Express.ShowExceptions)
...
get(/articles\/(\d+)/, function(){
  redirect('http://google.com') // TODO: remove / fix
