 ...
 *
 * This function sets the response status code and expects an integer value between 100 and 999 inclusive.
 * It throws an error if the provided status code is not an integer or if it's outside the allowable range.
 *
