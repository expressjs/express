...
res.json = function(obj){
  ...
  // Explicitly convert undefined to null because
  // JSON.stringify(undefined) returns undefined and
  // JSON.stringify(null) returns 'null', so in first case
  // we end up with an empty response ('') and content type being
  // application/json, and it affects clients like superagent, etc.,
  // and those crashes with SyntaxError: Unexpected end of input
