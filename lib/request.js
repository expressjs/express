...
/**
 * Given an {Array} of `types`, returns the best match for the given `Accept`
 * header. If false is returned, then you should respond with 406
 * "Not Acceptable".
 *
 * Examples:
 *
 ...
 *
 *     // Accept: text/html
 *     req.accepts(['xml', 'html']);
 *     // => "text/html"
 *
 *     // Accept: text/*; application/json
 *     req.accepts(['html','text/html','text/plain','application/json']);
 *     // => "text/html"
 *
 *     req.accepts(['image/png']);
 *     // => null
...
/*     req.accepts(['application/json', 'text/html']);
 *     // => "text/html"
 */
       // Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8
/*     req.accepts(['application/json']);
...
req.accepts = function(types){
  return utils.accepts(types, this.header('Accept'));
};
