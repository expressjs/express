...
/**
 * Given a list of `types`, returns the best match for the given `Accept`
 * header. If null is returned, then you should respond with 406
 * "Not Acceptable".
 *
 * Examples:
 *
 *     // Accept: text/html
 *     req.acceptBestMatch(['xml', 'html']);
 *     // => "text/html"
 *
 *     // Accept: text/*; application/json
 *     req.acceptBestMatch(['html','text/html','text/plain','application/json']);
 *     // => "text/html"
 *
 *     req.acceptBestMatch(['image/png']);
 *     // => null
 */
       // Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8
/*     req.acceptBestMatch(['application/json', 'text/html']);
 *     // => "text/html"
 */
       // Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8
/*     req.acceptBestMatch(['application/json']);
 *     // => "application/json"
 *
 * @param {Array} types
 * @return {String}
...
req.acceptBestMatch = function(types){
  return utils.acceptBestMatch(types, this.header('Accept'));
};
