...
/**
 * Initialize a new `View` with the given `view` path,
...
var View = exports = module.exports = function View(view, options, fn) {
  options = options || {};
  ...
  this.defaultEngine = options.defaultViewEngine;
...
View.prototype.resolveObjectName = function(){
  // TODO: cache
  return this.view
    .split('/')
    .slice(-1)[0]
...
View.prototype.__defineGetter__('contents', function(){
  return fs.readFileSync(this.view, 'utf8');
});
