...
## Quick Start
  ...
  The quickest way to get started with Express is to use the executable [`express(1)`](https://github.com/expressjs/generator) to generate an application as shown below:
